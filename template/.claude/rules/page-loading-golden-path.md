...
- 導航 loading 是每個 Nuxt consumer 都會遇到的 cross-cutting concern，散規範必漂移：盤點顯示 <consumer-b> 有完整 pattern、<consumer-a>/starter 有分歧半套、<consumer-d> / <consumer-c> / <consumer-k> / <consumer-i> 全缺。
